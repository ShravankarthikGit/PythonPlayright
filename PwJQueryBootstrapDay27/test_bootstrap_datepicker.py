...
def test_booking_Date_picker(page: Page):
    ...
    # role="dialog" is a universal HTML accessibility attribute (part of the ARIA standard).
    # It tells web browsers and screen readers:
    # "Everything inside this specific HTML container is a popup modal window, not the main background webpage."
    dismiss_btn = page.locator('[role="dialog"] button[aria-label*="Dismiss sign-in info"]')
    # page.locator("div[role='dialog'] button[aria-label*='Dismiss sign-in info']")
