...
# pytest class should always have Test as prefix
class TestClass:
    def test_one(self):
        print("this is my test one from TestClass")

    def test_two(self):
        print("this is my test two from TestClass")

    def test_three(self):
        print("this is my test three from TestClass")
