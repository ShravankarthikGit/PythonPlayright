...
def test_bootstrapdropdown(page : Page):
    ...
    # page.locator("i.oxd-icon.bi-caret-down-fill.oxd-select-text--arrow").nth(2).click()
    ...
    # In bootstrap down we cant get selected value using input_value()
    # selected_value = page.locator("form i").nth(2).input_value()
